...
func (h *Handler) Index(w http.ResponseWriter, r *http.Request) {
	...
	subs, subsPag, err := h.subscriptionRepository.FindAll(r.Context(), pag, h.getResourceID(r))
	if err != nil {
...
func (h *Handler) Show(w http.ResponseWriter, r *http.Request) {
	subs, err := h.subscriptionRepository.FindOne(
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	resource, err := h.resourceRepository.FindOne(r.Context(), h.getResourceID(r))
	if err != nil {
		status := http.StatusInternalServerError
