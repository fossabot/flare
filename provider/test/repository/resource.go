...
func (r *Resource) FetchPartitions(ctx context.Context, id string) (partitions []string, err error) {
	if r.err != nil {
		return nil, r.err
	}
	...
	return r.base.FetchPartitions(ctx, id)
}
...
func (r *Resource) LeavePartition(ctx context.Context, id, partition string) error {
	...
	return r.base.LeavePartition(ctx, id, partition)
}
...
func (r *Resource) JoinPartition(ctx context.Context, id string) (string, error) {
	...
	return r.base.JoinPartition(ctx, id)
}
