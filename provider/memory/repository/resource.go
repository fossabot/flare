...
func (r *Resource) findOne(_ context.Context, id string) (*resource, error) {
...
func (r *Resource) Delete(ctx context.Context, id string) error {
	...
	_, pagination, err := r.repository.FindAll(ctx, &flare.Pagination{Limit: 1}, id)
	if err != nil {
...
// FetchPartitions return the partitions a given resource have.
